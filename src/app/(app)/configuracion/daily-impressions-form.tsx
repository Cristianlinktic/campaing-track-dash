...
import { saveDailyImpressionsAction } from "@/app/(app)/actions";
import { CHANNELS } from "@/lib/constants";
import { formatDate } from "@/lib/format";
import type { DailyImpressions, DailyPlan } from "@/lib/types";
    ...
    <form action={formAction}>
      ...
      <div className="mt-4 flex items-center justify-between">
        <p className="text-xs text-slate-400">
          Número de impresiones reales por canal y por día. Deja en 0 los días sin datos aún.
        </p>
        <SubmitButton />
      </div>
    </form>
